...
def get_indeed_search_url(keyword, location, offset=0):
    parameters = {"q": keyword, "l": location, "filter": 0, "start": offset, "vjk":"b1083ef10100aa80"}
    return "https://uk.indeed.com/jobs?" + urlencode(parameters)

# https://uk.indeed.com/jobs?q=web+developer&l=Norwich%2C+Norfolk&vjk=b1083ef10100aa80
