...
export default function SignUp() {
  ...
  const error = router.query ? (router.query.error as string) : null;
        ...
        >
          <Box sx={{ mb: 3 }}>
            <Link href="/auth/signin">
              <Button size="small" sx={{ position: "absolute" }}>
                <ArrowBackIcon sx={{ mr: 1 }} /> Sign In
              </Button>
            </Link>
          ...
          >
            ...
            {success && (
              <Alert severity="success">
                Your user account was created successfully but requires staff
