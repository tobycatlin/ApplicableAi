...
module "nakama" {
  ...
  environment_name = "dev"        # used to name resouces and also is the subdomain
  dns_subdomain_name= "dev"
  ...
  nakama_image = "282085490514.dkr.ecr.eu-west-2.amazonaws.com/nakama:dev"
  admin_image = "282085490514.dkr.ecr.eu-west-2.amazonaws.com/ags_admin-aws:dev"
}
